...
public class SeekBarPreference extends DialogPreference implements SeekBar.OnSeekBarChangeListener, OnClickListener
{
    ...
    private String mSummaryDefault;
    ...
    public SeekBarPreference(Context context, AttributeSet attrs) {
        ...
        int mSummaryDefaultId = attrs.getAttributeResourceValue(androidns, "summary", 0);
        if(mSummaryDefaultId == 0) mSummaryDefault = attrs.getAttributeValue(androidns, "summary");
        else mSummaryDefault = mContext.getString(mSummaryDefaultId);
    ...
    public String getSummaryDefault() {
        return mSummaryDefault;
    }
